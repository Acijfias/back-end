...
<div>
    ...
    <main class="d-flex justify-content-center align-items-center">
        <div class="container">
            <a href="./create.php"  class="btn btn-primary">Qo'shish</a>
                ...
                <?php foreach ($dataAll as $data): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="./edit.php?id=<?= $data['id']?>" class="btn btn-success">Uptade</a>
                            <a href="./delete.php?id=<?= $data['id']?>" class="btn btn-danger" onclick="return confirm('Ochirilsinmi')">Delete</a>
                        </td>
